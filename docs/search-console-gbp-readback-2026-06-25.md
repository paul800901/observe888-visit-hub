...
- 01:35-01:45 追加修改 GBP 商家描述，詳見下方「GBP 描述修正」；除此之外，沒有修改 GBP 服務、產品、貼文、照片、地址、電話、網站、預約連結、營業時間或商家代碼。
...
操作時間：2026-06-25 01:35-01:45（Asia/Taipei）。

操作範圍：

- 只修改 Google Business Profile `商家資訊 > 簡介 > 說明`。
- 未修改地址、電話、網站、預約連結、營業時間、類別、產品、服務、貼文、照片、商家代碼或 Google 資訊更新。
- 沒有按 Search Console `要求建立索引`。

### 南區店

後台說明欄已從舊防衛式尾句 `本站不提供醫療診斷或療效保證` 改為：

```text
見觀結構調理整復所-南區店位於台南市南區明興路673號，採工作室預約制。服務以傳統整復推拿、身體結構觀察、結構調理、徒手調理、姿勢與承重線索整理為主，協助來訪者把肩頸腰背卡緊、落枕、閃到腰、久坐起身卡卡或四肢不順等感受說清楚，再依當次狀態安排內容與時間。常見搜尋像台南推拿、台南按摩、台南整復推拿、台南整骨、台南喬骨、台南筋膜放鬆或南區整復推拿，多半是在確認服務方式、到店距離、費用與預約流程；第一次來建議先看南區店頁、費用說明或到店導航，再用 LINE 或電話確認可安排時段。
```

讀回：

- 商家資訊對話框內 `說明` 欄已讀回新描述。
- 儲存中狀態消失後再次讀回，欄位仍是新描述。
- Google 搜尋右側公開預覽仍可能暫時顯示舊描述；本紀錄不宣稱公開快取已更新。

### 北區店

後台說明欄已從舊防衛式尾句 `本站不提供醫療診斷或療效...` 改為：

```text
見觀結構調理整復所-北區店位於台南市北區北安路一段211號，採一對一預約為主。服務以傳統整復推拿、身體結構觀察、結構調理、徒手調理、姿勢與承重線索整理為核心，協助來訪者把肩頸腰背卡緊、落枕、久坐卡卡、運動後拉不開或左右出力不順等身體感受說清楚，再依當次狀態安排內容與時間。常見搜尋像台南推拿、台南按摩、台南整復推拿、台南整骨、台南喬骨、台南筋膜放鬆或北區整復推拿，多半是在確認服務方式、到店距離、費用與預約流程；第一次來建議先看官網導航與費用頁，再用 LINE 或電話確認可安排時段。
```
...
2. `Google 資訊更新 (2)` 與南區 `缺少商家代碼 (1)` 仍未處理；若要處理，需先決定是否接受 Google 建議、是否填南區商家代碼，以及代碼命名規則。
3. 後續若要驗證公開面，需另做 Google Search / Maps 公開讀回；本次只確認 GBP 後台欄位儲存成功。
