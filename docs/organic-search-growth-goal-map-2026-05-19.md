...
- 使用者無痕自然搜尋讀回顯示，見觀官網在 `台南推拿`、`台南整復`、`台南整復推拿` 均約第 1 頁第 3 位，`台南整復推拿推薦` 與 `台南整骨` 約第 1 頁第 5 位，`台南整骨推薦` 約第 2 頁第 2 位；目前最明顯缺口已轉向 Maps / Google Business，而不是官網自然搜尋第一頁能見度。
...
| 4. Google Business / Maps | 南北店網站、預約、服務、照片、貼文、公開面讀回 | local pack 和地圖流量是最大外部入口 | 官網自然搜尋已較前面；目前缺口集中在 Maps / GBP |
