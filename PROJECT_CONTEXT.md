...
`D:\見觀營運資料夾\01_官網_ObserveGeoPages` 是見觀結構正式官網、到店導航、品牌內容、身體觀察筆記、Google 商家資料一致性與 GEO / AEO 內容的主專案。

`D:\見觀營運資料夾\02_廣告_AdsControl` 是廣告與營運監測專案，不再是官網 source。它可以同步與分析官網事件，但不能作為正式官網頁面或 Google 商家資料的主控端。
