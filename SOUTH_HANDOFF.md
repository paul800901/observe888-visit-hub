...
> note: 2026-05-20 South-side handoff snapshot kept for historical context only.

# 南區接手交接

> 歷史快照（2026-07-07）：本檔是 2026-05-20 的南區接手快照，保留當時操作脈絡與讀回結果，不得作為現行規則入口。現行入口先讀 `README.md`、`HANDOFF.md`、頂層 `..\docs\OPS_RULES_CURRENT.md`；舊工作區路徑只代表當時語境，不是現在正式入口。
...
- 不要把南區文案主體寫成治療、根治、保證改善或官方成功案例；若是匿名患者或故事角色的主觀感受，可保留前後差異，但不能寫成官方保證或可識別個案。
